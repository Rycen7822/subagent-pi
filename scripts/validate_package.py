...
assert portable['version']==legacy['version']=='0.1.0'
...
for f in ('getting-started','lifecycle','configuration','recovery','troubleshooting','cli','architecture','testing','sources'):
