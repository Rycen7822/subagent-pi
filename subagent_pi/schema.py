...
TOOLS=[
 ...
 tool('pi_interrupt_agent','interrupt','Cancel queued work and terminate the owned child process group with verified cleanup. Preserve the session for explicit respawn.',
